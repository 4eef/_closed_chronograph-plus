...
MENU_PAR(scrmode,       sysPars.modeTxts[0],    &sysPars.dispMode,      NULL,                   SCR_MODES_NO,           NULL,                   NULL);
MENU_PAR(sccedit,       "pcs",                  &chron.clipCapacity,    &chron.clipCurrent,     eNoFract,               PELLET_MAX,             PELLET_MIN);
MENU_PAR(potedit,       "min",                  &power.uptimeSet,       NULL,                   eNoFract,               POWER_RUN_MAX,          POWER_RUN_MIN);
MENU_PAR(sdedit,        "mm",                   &chron.sensDist,        NULL,                   eTenths,                CHR_DIST_MAX,           CHR_DIST_MIN);
MENU_PAR(rgbedit,       "deg",                  &meas.accRollBorder,    NULL,                   eNoFract,               INC_BORDER_MAX,         INC_BORDER_MIN);
MENU_PAR(pdb1edit,      "g",                    &pellets.pel[0].wght,   &pellets.pel[0].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb2edit,      "g",                    &pellets.pel[1].wght,   &pellets.pel[1].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb3edit,      "g",                    &pellets.pel[2].wght,   &pellets.pel[2].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb4edit,      "g",                    &pellets.pel[3].wght,   &pellets.pel[3].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb5edit,      "g",                    &pellets.pel[4].wght,   &pellets.pel[4].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb6edit,      "g",                    &pellets.pel[5].wght,   &pellets.pel[5].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb7edit,      "g",                    &pellets.pel[6].wght,   &pellets.pel[6].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb8edit,      "g",                    &pellets.pel[7].wght,   &pellets.pel[7].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb9edit,      "g",                    &pellets.pel[8].wght,   &pellets.pel[8].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb10edit,     "g",                    &pellets.pel[9].wght,   &pellets.pel[9].name,   eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb11edit,     "g",                    &pellets.pel[10].wght,  &pellets.pel[10].name,  eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb12edit,     "g",                    &pellets.pel[11].wght,  &pellets.pel[11].name,  eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb13edit,     "g",                    &pellets.pel[12].wght,  &pellets.pel[12].name,  eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb14edit,     "g",                    &pellets.pel[13].wght,  &pellets.pel[13].name,  eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
MENU_PAR(pdb15edit,     "g",                    &pellets.pel[14].wght,  &pellets.pel[14].name,  eHundreds,              PELLET_WGH_MG10_MAX,    PELLET_WGH_MG10_MIN);
