...
* MEMORY
*/
const char font6x8[256][6]={//[128][6]={//
    ...
    {0x00,0x01,0x01,0x01,0x01,0x01},    // 0xDF
    {0x00,0x3C,0x42,0x43,0x3D,0x00},    // 0xE0
    {0x00,0xFE,0x4A,0x4A,0x34,0x00},    // 0xE1
    {0x00,0x01,0x31,0x4A,0x3C,0x02},    // 0xE2
    {0x00,0x3D,0x43,0x42,0x3C,0x00},    // 0xE3
    {0x00,0x32,0x49,0x4A,0x31,0x00},    // 0xE4
    {0x1C,0x22,0x22,0x26,0x1A,0x02},    // 0xE5
    {0xFF,0x20,0x20,0x10,0x3F,0x20},    // 0xE6
    {0x00,0xFE,0xAA,0x28,0x10,0x00},    // 0xE7
    {0x00,0x0C,0x12,0xFF,0x12,0x0C},    // 0xE8
...
const char font12x16[17][24]={
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,0x00,0x38,0x00,0x38,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 0x2E (dot)
    {0x00,0x00,0x08,0x1F,0x04,0x01,0x02,0x06,0x01,0x01,0x00,0x9E,0x04,0x40,0x2A,0x20,0x2A,0x10,0x2A,0x08,0x10,0x04,0x00,0x00},// 0x2F (m/s)
    {0x00,0x00,0x07,0xF8,0x1F,0xFE,0x1E,0x06,0x33,0x03,0x31,0x83,0x30,0xC3,0x30,0x63,0x30,0x33,0x18,0x1E,0x1F,0xFE,0x07,0xF8},// 0x30 (1)
    {0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x0C,0x30,0x0C,0x30,0x0E,0x3F,0xFF,0x3F,0xFF,0x30,0x00,0x30,0x00,0x30,0x00,0x00,0x00},// 0x31 (2)
    {0x00,0x00,0x30,0x1C,0x38,0x1E,0x3C,0x07,0x3E,0x03,0x37,0x03,0x33,0x83,0x31,0xC3,0x30,0xE3,0x30,0x77,0x30,0x3E,0x30,0x1C},// 0x32 (3)
    {0x00,0x00,0x0C,0x0C,0x1C,0x0E,0x38,0x07,0x30,0xC3,0x30,0xC3,0x30,0xC3,0x30,0xC3,0x30,0xC3,0x39,0xE7,0x1F,0x7E,0x0E,0x3C},// 0x33 (4)
    {0x00,0x00,0x03,0xC0,0x03,0xE0,0x03,0x70,0x03,0x38,0x03,0x1C,0x03,0x0E,0x03,0x07,0x3F,0xFF,0x3F,0xFF,0x03,0x00,0x03,0x00},// 0x34 (5)
    {0x00,0x00,0x0C,0x3F,0x1C,0x7F,0x38,0x63,0x30,0x63,0x30,0x63,0x30,0x63,0x30,0x63,0x30,0x63,0x38,0xE3,0x1F,0xC3,0x0F,0x83},// 0x35 (6)
    {0x00,0x00,0x0F,0xC0,0x1F,0xF0,0x39,0xF8,0x30,0xDC,0x30,0xCE,0x30,0xC7,0x30,0xC3,0x30,0xC3,0x39,0xC3,0x1F,0x80,0x0F,0x00},// 0x36 (7)
    {0x00,0x00,0x00,0x03,0x00,0x03,0x00,0x03,0x30,0x03,0x3C,0x03,0x0F,0x03,0x03,0xC3,0x00,0xF3,0x00,0x3F,0x00,0x0F,0x00,0x03},// 0x37 (8)
    {0x00,0x00,0x0F,0x00,0x1F,0xBC,0x39,0xFE,0x30,0xE7,0x30,0xC3,0x30,0xC3,0x30,0xC3,0x30,0xE7,0x39,0xFE,0x1F,0xBC,0x0F,0x00},// 0x38 (9)
    {0x00,0x00,0x00,0x3C,0x00,0x7E,0x30,0xE7,0x30,0xC3,0x30,0xC3,0x38,0xC3,0x1C,0xC3,0x0E,0xC3,0x07,0xE7,0x03,0xFE,0x00,0xFC},// 0x39 (0)
    {0x00,0x00,0x0E,0x00,0x1E,0x00,0x38,0x00,0x30,0x00,0x30,0x00,0x30,0x00,0x30,0x00,0x38,0x00,0x1F,0xFF,0x07,0xFF,0x00,0x00},// 0x3A (J)
    {0x00,0x02,0x00,0x03,0x00,0x07,0x00,0x1F,0x38,0xFF,0x3F,0xFC,0x1F,0xC0,0x00,0xE0,0x00,0x7C,0x00,0x1F,0x00,0x07,0x00,0x01},// 0x3B (gamma)
    {0x00,0x00,0x00,0x08,0x00,0x3E,0x00,0x67,0x00,0xC3,0x1C,0xC0,0x3F,0xFE,0x1C,0xC3,0x00,0xC3,0x00,0x67,0x00,0x3E,0x00,0x08},// 0x3C (phi)
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1E,0x00,0x3F,0x00,0x33,0x00,0x33,0x00,0x3F,0x00,0x1E,0x00,0x00,0x00,0x00,0x00,0x00},// 0x3D (degree)
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 0x3E (empty)
};
